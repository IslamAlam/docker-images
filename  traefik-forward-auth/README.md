This image is based on thomseddon/traefik-forward-auth but it is using multi-arch Docker images to support apps on architecture [linux/amd64, linux/386, linux/arm64, linux/ppc64le, linux/s390x, linux/arm/v7, linux/arm/v6].

So the image can be pulled direcly for Raspberry Pi or any of the supported architecture
...
(https://github.com/prometheus/prometheus/issues/3619)[multi arch]